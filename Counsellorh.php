...
?>
      ...
      <td>
      <button type="submit" id="butE<?php echo $snd;?><?php echo $fna;?>" onclick="save('<?php echo $cousid;?>')" class="btn btn-success ml-2 d-none" data-toggle="modal" data-target="#exampleModalLong1">View<i class='fas fa-eye ml-1'></i></button>
      </td>
    </tr>
    <?php                              
}
