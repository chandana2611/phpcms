...
?>
      ...
      <?php
                        ...
                        ?>
      <td>
      <button type="submit" id="butE<?php echo $snd;?><?php echo $fna;?>" onclick="save('<?php echo $sduid;?>','<?php echo $sdfn;?>')" class="btn btn-success ml-2 d-none" data-toggle="modal" data-target="#exampleModalLong3">EDIT<i class='fas fa-eye ml-1'></i></button>
      </td>
...
?>
    ...
    <th scope="row"><?php echo $row["usn"];?></th> 
      ...
      <td><button type="submit" onclick="save1('<?php echo $spuid;?>','<?php echo $spph;?>')" id="butE<?php echo $snd1;?><?php echo $fna1;?>" class="btn btn-success ml-2 d-none" data-toggle="modal" data-target="#exampleModalLong4">View<i class='fas fa-eye ml-1'></i></button></td>    
    </tr>
    <?php                              
}
}
...
?>
  <?php $snd2 = $row["usn"];
    ...
    <tr onmouseover="show('butE<?php echo $snd2;?><?php echo $fna2;?>')" onmouseout="hide('butE<?php echo $snd2;?><?php echo $fna2;?>')">
      ...
      <td><button type="submit" id="butE<?php echo $snd2;?><?php echo $fna2;?>" onclick="save2('<?php echo $smuid;?>')" class="btn btn-success ml-2 d-none" data-toggle="modal" data-target="#exampleModalLong5">View<i class='fas fa-eye ml-1'></i></button></td>    
...
?>
  <?php $snd3 = $row["usn"];
    ...
    <th scope="row"><?php echo $row["usn"];?></th>
      ...
      <td><?php echo $row["phno"];?></td>
      <td><button type="submit" id="butE<?php echo $snd3;?><?php echo $fna3;?>"  onclick="save3('<?php echo $sdduid;?>')" class="btn btn-success ml-2 d-none" data-toggle="modal" data-target="#exampleModalLong6">View<i class='fas fa-eye ml-1'></i></button></td>    
    </tr>
    <?php                              
}
}
